...
public class Utils
{
    ...
    public static string StartupPath()
    {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "KNcloud");
        }
    ...
    public static bool IsPackagedInstall()
    {
        try
        {
            ...
            if (p.StartsWith("/opt/KNcloud", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/lib/KNcloud", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/share/KNcloud", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }
        }
