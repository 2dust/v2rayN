                ...
                .Subscribe(configType =>
                {
                    ...
                    switch (configType)
                    {
                        ...
                        case EConfigType.HTTP:
                            this.Bind(ViewModel, vm => vm.SelectedSource.Password, v => v.txtId4.Text).DisposeWith(currentTypeDisposables);
                            this.Bind(ViewModel, vm => vm.SelectedSource.Username, v => v.txtSecurity4.Text).DisposeWith(currentTypeDisposables);
                            break;
