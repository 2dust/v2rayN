...
if command -v apt-get >/dev/null 2>&1; then
  ...
  # Install .NET SDK 8 via official script (works for arm64 too)
...
Section: net
Priority: optional
Depends: libc6 (>= 2.34), libfontconfig1 (>= 2.13.1), libfreetype6 (>= 2.10), libglib2.0-0, libcairo2, libpango-1.0-0, libpangocairo-1.0-0, libegl1, libgl1, xdg-utils, desktop-file-utils, bash (>= 5.1)
