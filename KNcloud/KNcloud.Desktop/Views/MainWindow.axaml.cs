...
using KNcloud.Desktop.Common;
using KNcloud.Desktop.Manager;
...
public partial class MainWindow : WindowBase<MainWindowViewModel>
{
    ...
    private void AddHelpMenuItem()
    {
        ...
        {
            Tag = "https://www.kncloud.top",
            Header = string.Format(ResUI.menuWebsiteItem, ECoreType.KNcloud.ToString()).UpperFirstChar()
        };
