...
namespace ServiceLib.Resx {
    ...
    public class ResUI {
        ...
        /// <summary>
        ///   查找类似 Warning: allowInsecure has been completely removed in Xray v26.2.6+ (since 2026.6.1).
        ///   的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Error: allowInsecure is no longer supported by Xray v26.2.6+. 的本地化字符串。
        ///   Xray 节点启用 allowInsecure 且无证书固定时的错误提示。
        /// </summary>
        public static string MsgAllowInsecureRemovedXray {
            get {
                return ResourceManager.GetString("MsgAllowInsecureRemovedXray", resourceCulture);
            }
        }
        
        /// <summary>
        ///   查找类似 Notice: allowInsecure is removed in Xray v26.2.6+. CertSha256 is provided so pinnedPeerCertSha256 will be used automatically.
        ///   的本地化字符串。已有 CertSha 时自动迁移的警告提示。
        /// </summary>
        public static string MsgAllowInsecureAutoMigratedXray {
            get {
                return ResourceManager.GetString("MsgAllowInsecureAutoMigratedXray", resourceCulture);
            }
        }
