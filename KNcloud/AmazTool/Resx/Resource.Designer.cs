...
namespace AmazTool.Resx {
    ...
    internal class Resource {
        ...
        /// <summary>
        ///   查找类似 Failed to terminate the KNcloud. Close it manually, or the upgrade may fail. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Start KNcloud, please wait... 的本地化字符串。
        /// </summary>
        internal static string RestartKNcloud {
            get {
                return ResourceManager.GetString("RestartKNcloud", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Try to terminate the KNcloud process... 的本地化字符串。
        /// </summary>
