...
namespace ServiceLib.Resx {
    ...
    public class ResUI {
        ...
        /// <summary>
        ///   查找类似 Custom Tun IPv4 Address 的本地化字符串。
        /// </summary>
        public static string TbSettingsTunIPv4Address {
            get {
                return ResourceManager.GetString("TbSettingsTunIPv4Address", resourceCulture);
            }
        }

        /// <summary>
        ///   查找类似 Custom Tun IPv6 Address 的本地化字符串。
        /// </summary>
        public static string TbSettingsTunIPv6Address {
            get {
                return ResourceManager.GetString("TbSettingsTunIPv6Address", resourceCulture);
            }
        }
